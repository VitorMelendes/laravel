      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><strong>Descrição:</strong> Rex é um cachorro muito brincalhão e cheio de energia. Adora passeios e se dá bem com crianças e outros animais. Ele está procurando um lar amoroso onde possa receber muito carinho e atenção.</p>
            <p><strong>Histórico:</strong> Rex foi resgatado das ruas e está sob nossos cuidados há 3 meses. Ele já foi vacinado, castrado e está pronto para encontrar uma família.</p>
            <button class="btn btn-primary">Quero Adotar!</button>
          </div>
        </div>
      </div>
    </section>
